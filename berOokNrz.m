...
% and Channel Modelling with MATLAB 
% Abu Bakar Siddique
...
for i=1:length(SNR)
    ...
    sgma(i)=sqrt(N0/2/Tsamp); % noise variance
...
hold on
semilogy(EbN0,qfunc(sqrt(10.^(EbN0/10))),'r-X','linewidth',1);
% theoretical ber, 'mx-');
grid on
